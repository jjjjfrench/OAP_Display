PRO OAPdisplay
  ...
  common block1, fileinfo, display_info, prbtype, hhmmss, pos, scnt, rec, diam, percentage, nth, hab, hab_selection, auto_reject
  ...
  display_info = {fname_base:'No File Selected', fname_proc:'No File Selected', path:'/kingair_data/snowie17/2DS/', $
    ...
    img_stt:'Image Start: hhmmss', img_stp:'Image Stop: hhmmss', img_minD:'Image MinD: 0',  img_maxD:'Image MaxD: 2000',  img_nth:'Image nth: 1', $
  ...
  ;Image Information
  ImageInfo_id=WIDGET_LABEL(base_widg,value=display_info.image_percent,xsize=270,ysize=15,xoff=10,yoff=560, /ALIGN_LEFT,$
    uname='Percent')
  ImageSTT_id=WIDGET_LABEL(base_widg,value=display_info.img_stt,xsize=120,ysize=15,xoff=280,yoff=560, /ALIGN_LEFT,$
    uname='imgSTT')
  ImageSTP_id=WIDGET_LABEL(base_widg,value=display_info.img_stp,xsize=120,ysize=15,xoff=425,yoff=560, /ALIGN_LEFT,$
    uname='imgSTP')
  ImageMIND_id=WIDGET_LABEL(base_widg,value=display_info.img_minD,xsize=120,ysize=15,xoff=580,yoff=560, /ALIGN_LEFT,$
    uname='imgMIND')
  ImageMAXD_id=WIDGET_LABEL(base_widg,value=display_info.img_maxD,xsize=110,ysize=15,xoff=700,yoff=560, /ALIGN_LEFT,$
    uname='imgMAXD')
